...
export class PurchaseInvoice extends AggregateRoot<string> {
  ...
  get currentStatus(): PurchaseInvoiceStatus {
    return this.status;
  }
  get amount(): Money {
    return this.total;
